...
exports.TrainingEmpController = void 0;
const responseBuilder_1 = require("../../../helpers/responseBuilder");
const trainingempUtils_1 = require("./trainingempUtils");
...
class TrainingEmpController {
    constructor() {
        this.trainingUtils = new trainingempUtils_1.TrainingEmpUtils();
         ...
         * @param res
         */
        this.linkEmployee = (req, res) => __awaiter(this, void 0, void 0, function* () {
            const check = yield trainingempSchema_1.TrainingEmp.findOne({ training_id: req.body.training_id });
            var training = yield trainingSchema_1.Training.findOne({ _id: req.body.training_id });
            // return false;
            if (Object.is(check, null)) {
                const trainingData = yield this.trainingUtils.create(req.body);
                var response = responseBuilder_1.ResponseBuilder.respSuccess(trainingData, req.t("SUCCESS"));
                if (response) {
                    const data = {
                ...
                const trainingEmp = yield trainingempSchema_1.TrainingEmp.findOne({ training_id: req.body.training_id });
                ...
                if (output.length > 0) {
                    for (let i = 0; i < output.length; i++) {
                        const match = yield userSchema_1.User.findOne({ _id: output[i] });
                ...
                const data = yield trainingempSchema_1.TrainingEmp.findByIdAndUpdate({ _id: trainingEmp._id }, { $push: { emp_id: req.body.emp_id } }, { new: true });
                var response = responseBuilder_1.ResponseBuilder.respSuccess(data, req.t("SUCCESS"));
                if (response) {
                    const data = {
                        emp_id: req.payload._id,
                        training_id: training._id,
        ...
        this.notifyParticipants = (req, res) => __awaiter(this, void 0, void 0, function* () {
            try {
                const reqArr = [
                    {
                        $match: {
                ...
                const data1 = yield trainingempSchema_1.TrainingEmp.aggregate(reqArr).exec();
                ...
                if (Object.is(data1, null) || data1 === [] || data1.length === 0 || data1[0].employee.length === 0) {
                    ...
                    return res.status(commonMessage_1.MessageModule.status.not_found).json(response);
                }
                else {
                    var TrainingName = yield trainingSchema_1.Training.find({ _id: req.body.training_id });
         ...
         * @param mentor
         */
        this.sendEmail = (emails, mentor, data) => __awaiter(this, void 0, void 0, function* () {
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
      ...
      <tr style="background:#b3b3b3;color:black;"> 
        ...
        this.getEmployee = (req, res) => __awaiter(this, void 0, void 0, function* () {
            const employee = yield trainingempSchema_1.TrainingEmp.aggregate([
                {
                    "$match": { "training_id": mongoose_1.Types.ObjectId(req.body.id) }
                },
                {
                    "$lookup": {
                        "from": 'users',
            ...
            const trainingData = yield this.trainingUtils.getAll(req);
            const response = responseBuilder_1.ResponseBuilder.respSuccess(employee, req.t("SUCCESS"));
            res.status(commonMessage_1.MessageModule.status.ok).json(response);
        });
        /**
         * @method getEmployee
         ...
         * @param res
         */
        this.getEmployeeall = (req, res) => __awaiter(this, void 0, void 0, function* () {
            const employee = yield trainingempSchema_1.TrainingEmp.aggregate([
                {
                    "$lookup": {
                        "from": 'users',
        ...
        this.deleteEmployee = (req, res) => __awaiter(this, void 0, void 0, function* () {
            var TrainingEmploye = yield trainingempSchema_1.TrainingEmp.findOne({ training_id: req.body.training_id });
            var employee = yield userSchema_1.User.findOne({ _id: req.body.emp_id });
            var training = yield trainingSchema_1.Training.findOne({ _id: req.body.training_id });
            const resp = {
                success: 'employee deleted sucessfully'
            };
            const data = yield trainingempSchema_1.TrainingEmp.updateOne({ _id: TrainingEmploye._id }, { $pull: { emp_id: req.body.emp_id } });
            if (data) {
                yield progressSchema_1.Progress.remove({ training_id: req.body.training_id, emp_id: req.body.emp_id });
            }
            ...
            if (response) {
                ...
                yield this.timelineUtils.timeLine(timeline);
            }
            res.status(commonMessage_1.MessageModule.status.ok).json(response);
        });
        this.progressDataByTrainingemp = (req, res) => __awaiter(this, void 0, void 0, function* () {
            var totalVideos = yield trainingSchema_1.Training.find({ _id: req.body.training_id });
            const trainingVideos = yield progressSchema_1.Progress.find({ emp_id: req.body.emp_id, training_id: req.body.training_id });
            var sum = 0;
        ...
        this.Dashboard = (req, res) => __awaiter(this, void 0, void 0, function* () {
            try {
                const trainingCount = yield trainingSchema_1.Training.countDocuments();
                const platformCount = yield platformSchema_1.Platform.countDocuments();
                const userCount = yield userSchema_1.User.countDocuments();
                var TrainingEmploye = yield trainingempSchema_1.TrainingEmp.find({}).distinct('emp_id');
                const data = {
...
exports.TrainingEmpController = TrainingEmpController;
//# sourceMappingURL=trainingempController.js.map