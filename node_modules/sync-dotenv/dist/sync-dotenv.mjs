...
var fileExists = function (path) { return fs.existsSync(path); };
...
var writeToExampleEnv = function (path, parsedEnv) {
  fs.writeFile(path, envToString(parsedEnv), function (err) {
...
var syncEnv = function (filename) {
  var EXAMPLE_ENV_PATH = resolve(process.cwd(), filename || DEFAULT_EXAMPLE_ENV_FILENAME);
...
//# sourceMappingURL=sync-dotenv.mjs.map
